...
u = cos(2*3.14*2*t)+0.5*cos(2*3.14*3*t)+0.5*cos(2*3.14*200*t)
Du = diff(u);
D2u = diff(u,2);
Dy=diff(y);
D2y=diff(y,2);
resenje1=simplify(dsolve(D2y+99.56681*Dy+9070.20982*y==0.89125*D2u,y(0)==0, Dy(0)==0))
...
slika_drugog_izvoda_pobude=simplify((j*w)^2*slika_pobude)
leva_strana_RUI=collect(slika_drugog_izvoda_g+99.56681*slika_prvog_izvoda_g+9070.20982*G_w,'G_w')
desna_strana_RUI=0.89125*slika_drugog_izvoda_pobude
...
% karakteristike
resenje2 = amplituda_1*cos(2*3.14*2*t+faza_1)+amplituda_2*0.5*cos(2*3.14*3*t+faza_2)+amplituda_3*0.5*cos(2*3.14*200*t+faza_3)
